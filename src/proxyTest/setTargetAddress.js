const ProxyHelloWorldJSON = require('../../build/contracts/Proxy.json');
...
let ContractInstance = new web3.eth.Contract(ProxyHelloWorldJSON.abi, proxy_ledger); 

console.log(logic_ledger);
ContractInstance.methods.setTargetAddress(logic_ledger).send({
